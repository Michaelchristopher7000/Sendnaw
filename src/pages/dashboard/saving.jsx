  ...
  const handleSubmit = async () => {
    ...
    try {
      const res = await fetch(
        "https://sendnawbackend.onrender.com/api/savings/create.php",
        {
          method: "POST",
          headers: {
...
export default function Savings() {
  ...
  const fetchPlans = async () => {
    try {
      const res = await fetch(
        "https://sendnawbackend.onrender.com/api/savings/plans.php",
      );
      const data = await res.json();
  ...
  const fetchMySavings = async () => {
    try {
      const res = await fetch(
        "https://sendnawbackend.onrender.com/api/savings/list.php",
        {
  ...
  const withdrawSaving = async (savingId) => {
    ...
    try {
      const res = await fetch(
        "https://sendnawbackend.onrender.com/api/savings/withdraw.php",
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
  ...
  const requestLiquidation = async (savingId) => {
    ...
    try {
      const res = await fetch(
        "https://sendnawbackend.onrender.com/api/savings/liquidate.php",
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
