...
export default function Invest() {
  ...
  const fetchStocks = async () => {
    try {
      const res = await fetch(
        "http://sendnawtechnologies.infinityfree.io/api/invest/stocks.php",
      );
  ...
  const fetchPortfolio = async () => {
    try {
      const res = await fetch(
        "http://sendnawtechnologies.infinityfree.io/api/invest/portfolio.php",
        {
  ...
  const handleBuyConfirm = async (stockId, quantity) => {
    ...
    try {
      const res = await fetch(
        "http://sendnawtechnologies.infinityfree.io/api/invest/buy.php",
        {
          method: "POST",
          headers: {
  ...
  const handleSellConfirm = async (stockId, quantity) => {
    ...
    try {
      const res = await fetch(
        "http://sendnawtechnologies.infinityfree.io/api/invest/sell.php",
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
