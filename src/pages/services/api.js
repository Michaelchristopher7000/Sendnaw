const BASE = 'http://sendnawtechnologies.infinityfree.io/api';
...
export const storeFCMToken = async (token) => {
  const res = await fetch('http://sendnawtechnologies.infinityfree.io/api/notifications/store_token.php', {
    method: 'POST',
