...
export default function NotificationBell({ token }) {
  ...
  useEffect(() => {
    if (!token) return;
    fetch("http://sendnawtechnologies.infinityfree.io/api/notifications.php", {
  ...
  const markAsRead = async (id) => {
    try {
      await fetch(
        `http://sendnawtechnologies.infinityfree.io/api/notifications.php/${id}/read`,
        {
          method: "PUT",
          headers: { Authorization: `Bearer ${token}` },
        },
  ...
  const markAllAsRead = async () => {
    try {
      await fetch(
        `http://sendnawtechnologies.infinityfree.io/api/notifications.php/read-all`,
        {
          method: "PUT",
          headers: { Authorization: `Bearer ${token}` },
        },
